...
func main() {
	...
	flag.StringVar(&pmUsername, "apiUser", "", "Proxmox User. Can also be set via the PROXMOX_API_USERNAME environment variable")
	flag.StringVar(&pmPassword, "apiPassword", "", "Proxmox Password. Can also be set (and is recommended as such) via the PROXMOX_API_PASSWORD environment variable")
