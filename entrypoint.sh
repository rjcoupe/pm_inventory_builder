...
/app/pm_inventory_builder -url https://$PM_IP:$PM_PORT -allow-insecure-tls -ansible-user $PM_USER -tokenId $PM_TOKENID -tokenSecret $PM_TOKENSECRET > /data/my_proxmox_inventory.yaml
